...
public class ExoPlayerIntentModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    @ReactMethod
    public void showVideoPlayer(String url, String title, String sub, Callback callback) {
			
				RegisterCallBack rgstrCallback = new RegisterCallBack();
				
				if(callback!=null){
					rgstrCallback.setCallBack(callback);
				}
        ...
        if (currentActivity != null) {
            ...
            currentActivity.startActivityForResult(i, TAG);
				...
				// rgstrCallback.invokeCallBack("Hi Margaya");
    }
